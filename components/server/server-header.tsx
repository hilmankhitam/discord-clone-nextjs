  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56 space-y-[2px] text-xs font-medium text-black dark:text-neutral-400">
        {isModerator && (
          <DropdownMenuItem className="cursor-pointer px-4 py-2 text-sm text-indigo-500 dark:text-indigo-400">
            Invite People
            <UserPlus className="ml-auto h-4 w-4" />
          </DropdownMenuItem>
        )}
        {isAdmin && (
          <DropdownMenuItem className="cursor-pointer px-4 py-2 text-sm ">
            Server Settings
        ...
        {isAdmin && (
          <DropdownMenuItem className="cursor-pointer px-4 py-2 text-sm text-rose-500 ">
            Delete Server
